...
Write a function named raisedToTheThird that
 takes in an array of numbers and returns a new
  array of each of those numbers raised to the
   3rd power (hint: look up Math.pow()).
...
const raisedToTheThird = (arr) => {
  let newArr=[];
  arr.forEach((Element)=>{
    let powerThree=Math.pow(Element,3);
    newArr.push(powerThree);
  });
  return newArr;
};
...
const addOne = (arr) => {
  let newValue=arr.map((Element)=>Element+1);
  return newValue;
};
...
Write a function named addQuestion that, given an array
of strings, uses map to return a new array containing
 each string followed by a question mark character.
------------------------------------------------------------------------------------------------ */

const addQuestion = (arr) => {
  let newString=arr.map(Element=>Element+'?');
  return newString;
};
...
Write a function named forLoopTwoToThe that, given an array of
 ...
 returns a new array. The returned array should
  contain the result of raising 2 to the power of
   the original input element.

You may choose to complete this challenge using
 a for loop, for...in syntax, or for...of syntax.
...
const forLoopTwoToThe = (arr) => {
  ...
  for (let i=0;i<arr.length;i++){
    newValue.push(Math.pow(2,arr[i]));
  }
  return newValue;
};
/* ------------------------------------------------------------------------------------------------
...
const forEachTwoToThe = (arr) => {
  let newValue=[];
  arr.forEach((Element)=>newValue.push(Math.pow(2,Element)))
  return newValue;
};
